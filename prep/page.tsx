  ...
  return (
    <div>
      <div className="page-head" style={{ display:'flex', alignItems:'flex-end', justifyContent:'space-between', marginBottom:18 }}>
        <div>
          <div style={{ fontSize:13, fontWeight:500, color:'var(--muted)' }}>Prep · Question flashcards</div>
        ...
        <div className="page-head-actions" style={{ display:'flex', alignItems:'center', gap:20 }}>
          <div className="page-head-meta" style={{ display:'flex', alignItems:'baseline', gap:8 }}>
            ...
            <span style={{ fontSize:12, fontWeight:600, letterSpacing:'.04em', textTransform:'uppercase', color:'var(--muted)' }}>cards</span>
          </div>
      ...
      <div style={{ fontSize:12, color:'var(--muted)', marginBottom:18, lineHeight:1.5, maxWidth:680 }}>
        Flashcards — tap a card to flip between the question and your answer. Add your own as new questions come up in screens and mock interviews.
      </div>
          ...
          return (
            ...
            >
              <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:14 }}>
                <span style={{ fontSize:10, fontWeight:700, letterSpacing:'.06em', textTransform:'uppercase', color: isFlipped ? '#FBC4B2' : 'var(--accent-ink)', background: isFlipped ? 'rgba(245,85,46,.2)' : 'var(--accent-soft)', padding:'4px 11px', borderRadius:999 }}>
                  {c.tag}
                </span>
